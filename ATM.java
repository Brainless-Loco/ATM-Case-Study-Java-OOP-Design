...
public class ATM
{
    ...
    private int currentAccountNumber; //current user's current account number
    ...
    // no-argument ATM constructor initializes instances
    public ATM()
    {
    ...
    public void run()
    {
        // welcome and authenticate user; perfor, transactions
        while(true)
        {
    ...
    // return object of specified Transaction variable
